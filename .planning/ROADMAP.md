...
- [x] **Phase 3: Signer-Gated Writable Cache** - A connected signer can stream complete store objects into a private writable overlay while incomplete data remains invisible. (completed 2026-08-12)
...
- [x] 02-03-PLAN.md — Add verified local Blossom read-through/population and prove the full slice with stock Nix.
...
- [x] 03-01-PLAN.md — Gate stock-Nix streamed PUT staging behind one exact signer-owned capability.
- [x] 03-02-PLAN.md — Commit dependency-closed objects into an immutable signer-first overlay.
- [x] 03-03-PLAN.md — Freeze deterministic batches and build durable unpublished plaintext Hashtree candidates.
...
Plans:
- [ ] 04-01-PLAN.md — Trace one candidate through complete-replica proof, exact signing, configured-relay acknowledgement, and normal admission
- [ ] 04-02-PLAN.md — Add durable repair, refresh, optional local relay cache, and production lifecycle wiring
- [ ] 04-03-PLAN.md — Add typed secret-safe diagnostics and pure process/read/write health
...
| 4. Availability-Gated Publication Loop | 0/4 | Planned | - |
