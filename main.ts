...
const SUPPORTED_ENVIRONMENT_NAMES = [
  ...
  "NIXSTR_LOCAL_KEY_PATH",
  "NIXSTR_NIP46_SESSION_PATH",
  "NIXSTR_STAGING_DIRECTORY",
  "NIXSTR_STAGING_BODY_BYTES",
  "NIXSTR_STAGING_AGGREGATE_BYTES",
  "NIXSTR_NIX_SIG_KEYS",
  "NIXSTR_PUBLICATION_LIFETIME_SECONDS",
  "NIXSTR_LOCAL_RELAY_URL",
  "NIXSTR_PUBLICATION_CONCURRENCY",
  "NIXSTR_PUBLICATION_MAX_ATTEMPTS",
...
export function rawConfigFromEnvironment(
  ...
  return {
    ...
    localKeyPath: environment.NIXSTR_LOCAL_KEY_PATH,
    nip46SessionPath: environment.NIXSTR_NIP46_SESSION_PATH,
    stagingDirectory: environment.NIXSTR_STAGING_DIRECTORY,
    stagingBodyBytes: environment.NIXSTR_STAGING_BODY_BYTES,
    stagingAggregateBytes: environment.NIXSTR_STAGING_AGGREGATE_BYTES,
    nixSigKeys: environment.NIXSTR_NIX_SIG_KEYS,
    publicationLifetimeSeconds: environment.NIXSTR_PUBLICATION_LIFETIME_SECONDS,
    localRelayUrl: environment.NIXSTR_LOCAL_RELAY_URL,
    publicationConcurrency: environment.NIXSTR_PUBLICATION_CONCURRENCY,
    publicationMaxAttempts: environment.NIXSTR_PUBLICATION_MAX_ATTEMPTS,
    limits: {
