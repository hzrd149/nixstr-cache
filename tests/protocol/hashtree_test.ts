...
Deno.test("pinned BUD-16/17 vectors decode into strict manifests", () => {
  const directory = decodeManifest(
    hex(
      "82a16c9184a168c420ababababababababababababababababababababababababababababababababa16ea8746573742e747874a17364a17400a17402",
    ),
  ...
  const file = decodeManifest(
    hex(
      "82a16c9283a168c420aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa17364a1740083a168c420bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbba17332a17400a17401",
    ),
    { maxWireBytes: 4096, maxDecodedBytes: 4096, maxLinks: 10 },
  );
...
Deno.test("file and fanout invariants are validated completely", () => {
  assertThrows(
    () =>
      decodeManifest(encode({ l: [{ h: H(1), n: "bad", s: 1, t: 0 }], t: 1 }), {
        maxWireBytes: 4096,
        maxDecodedBytes: 4096,
        maxLinks: 10,
      }),
...
Deno.test("wire, decoded metadata, links, keys, and trailing data are bounded", () => {
  ...
  assertThrows(
    () =>
      decodeManifest(valid, {
        maxWireBytes: valid.length - 1,
        maxDecodedBytes: 99,
        maxLinks: 1,
      }),
    ManifestDataError,
  ...
  assertThrows(
    () =>
      decodeManifest(encode({ l: [{ h: H(1), n: "a", s: 1, t: 0 }], t: 2 }), {
        maxWireBytes: 4096,
        maxDecodedBytes: 1,
        maxLinks: 10,
      }),
  ...
  assertThrows(
    () =>
      decodeManifest(encode({ l: [], t: 2, x: 1 }), {
        maxWireBytes: 4096,
        maxDecodedBytes: 99,
        maxLinks: 1,
      }),
  ...
  assertThrows(
    () =>
      decodeManifest(new Uint8Array([...valid, 0]), {
        maxWireBytes: 4096,
        maxDecodedBytes: 99,
        maxLinks: 1,
      }),
